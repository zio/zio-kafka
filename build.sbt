...
lazy val embeddedKafkaVersion = "2.6.0" // Should be the same as kafkaVersion, except for the patch part
  ...
  project
    ...
    .settings(
      ...
      libraryDependencies ++= Seq(
        ...
        else Seq("io.github.embeddedkafka" %% "embedded-kafka" % embeddedKafkaVersion % "test")
      },
