...
See the [zio-kafka tutorial](docs/docs/tutorial.md) for a grand tour of the different ways you can use zio-kafka.

In order to use this library, we need to add the following line in our `build.sbt` file:

```scala
libraryDependencies += "dev.zio" %% "zio-kafka"         % "3.3.0"
libraryDependencies += "dev.zio" %% "zio-kafka-testkit" % "3.3.0" % Test
```
...
Read the [ZIO Kafka tutorial](docs/docs/tutorial.md) for a more gentle introduction.
